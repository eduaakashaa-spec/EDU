...
const COLLEGES_DB = [
  // ── IITs ──
  { n: "IIT Madras", s: "Tamil Nadu", d: "Chennai", t: "IIT", r: 1, nb: null, cp: [1,2,4,5], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Aero","Naval","EngPhy","EngDes","Bio"] },
  { n: "IIT Delhi", s: "Delhi", d: "South Delhi", t: "IIT", r: 2, nb: null, cp: [1,2,2,5], b: ["CSE","ECE","EE","Mech","Civil","Chem","Textile","EngPhy","Math","Prod"] },
  { n: "IIT Bombay", s: "Maharashtra", d: "Mumbai", t: "IIT", r: 3, nb: null, cp: [1,2,3,5], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Aero","EngPhy","Energy","Env"] },
  { n: "IIT Kanpur", s: "Uttar Pradesh", d: "Kanpur", t: "IIT", r: 4, nb: null, cp: [1,2,3,4], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Aero","Bio","Math"] },
  { n: "IIT Kharagpur", s: "West Bengal", d: "Paschim Medinipur", t: "IIT", r: 5, nb: null, cp: [1,2,6,4], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Aero","Mining","Marine","Naval","Agri","EarthSci"] },
  { n: "IIT Roorkee", s: "Uttarakhand", d: "Roorkee", t: "IIT", r: 6, nb: null, cp: [1,2,3,6], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Mining","Bio","PulpPaper","EarthSci","Arch"] },
  { n: "IIT Guwahati", s: "Assam", d: "Guwahati", t: "IIT", r: 8, nb: null, cp: [1,2,1,6], b: ["CSE","ECE","EE","Mech","Civil","Chem","Bio","Math","EngPhy","EngDes"] },
  { n: "IIT Hyderabad", s: "Telangana", d: "Sangareddy", t: "IIT", r: 7, nb: null, cp: [2,2,2,4], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Bio","Math","AIDS"] },
  { n: "IIT BHU Varanasi", s: "Uttar Pradesh", d: "Varanasi", t: "IIT", r: 10, nb: null, cp: [1,2,3,6], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Mining","Bio","Cer","Pharma","Arch"] },
  { n: "IIT ISM Dhanbad", s: "Jharkhand", d: "Dhanbad", t: "IIT", r: 15, nb: null, cp: [1,2,3,5], b: ["CSE","ECE","EE","Mech","Civil","MME","Mining","Petro","Chem","Env","MinMach"] },
  { n: "IIT Bhubaneswar", s: "Odisha", d: "Bhubaneswar", t: "IIT", r: 39, nb: null, cp: [1,2,3,2], b: ["CSE","ECE","EE","Mech","Civil","MME","Mining","EarthSci"] },
  { n: "IIT Indore", s: "Madhya Pradesh", d: "Indore", t: "IIT", r: 12, nb: null, cp: [1,2,2,5], b: ["CSE","ECE","EE","Mech","Civil","MME","Math","EngPhy","Space","Bio"] },
  { n: "IIT Gandhinagar", s: "Gujarat", d: "Gandhinagar", t: "IIT", r: 25, nb: null, cp: [1,2,2,3], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Math"] },
  { n: "IIT Mandi", s: "Himachal Pradesh", d: "Mandi", t: "IIT", r: 26, nb: null, cp: [2,2,1,2], b: ["CSE","ECE","EE","Mech","Civil","Bio","AIDS"] },
  { n: "IIT Jodhpur", s: "Rajasthan", d: "Jodhpur", t: "IIT", r: 27, nb: null, cp: [2,2,2,3], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","AIDS","Bio"] },
  { n: "IIT Patna", s: "Bihar", d: "Patna", t: "IIT", r: 19, nb: null, cp: [1,2,2,2], b: ["CSE","ECE","EE","Mech","Civil","MME","Chem"] },
  { n: "IIT Ropar", s: "Punjab", d: "Rupnagar", t: "IIT", r: 32, nb: null, cp: [2,2,2,3], b: ["CSE","ECE","EE","Mech","Civil","MME","Bio","AIDS","Math"] },
  { n: "IIT Tirupati", s: "Andhra Pradesh", d: "Tirupati", t: "IIT", r: 57, nb: null, cp: [1,2,1,2], b: ["CSE","ECE","EE","Mech","Civil","Chem"] },
  { n: "IIT Palakkad", s: "Kerala", d: "Palakkad", t: "IIT", r: 64, nb: null, cp: [2,2,1,1], b: ["CSE","ECE","EE","Mech","Civil","AIDS"] },
  { n: "IIT Bhilai", s: "Chhattisgarh", d: "Bhilai", t: "IIT", r: 72, nb: null, cp: [2,2,1,1], b: ["CSE","ECE","EE","Mech","Civil","AIDS"] },
  { n: "IIT Goa", s: "Goa", d: "Ponda", t: "IIT", r: null, nb: "101-150", cp: [1,2,2,1], b: ["CSE","ECE","EE","Mech","Civil","MME"] },
  { n: "IIT Jammu", s: "Jammu and Kashmir", d: "Jammu", t: "IIT", r: 56, nb: null, cp: [1,2,2,2], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME"] },
  { n: "IIT Dharwad", s: "Karnataka", d: "Dharwad", t: "IIT", r: 77, nb: null, cp: [1,2,1,2], b: ["CSE","ECE","EE","Mech","Civil","Chem"] },
  // ── NITs ──
  { n: "NIT Trichy", s: "Tamil Nadu", d: "Tiruchirappalli", t: "NIT", r: 9, nb: null, cp: [2,2,3,4], b: ["CSE","ECE","EEE","Mech","Civil","Chem","MME","Prod","ICT","Energy","Arch"] },
  { n: "NIT Surathkal", s: "Karnataka", d: "Dakshina Kannada", t: "NIT", r: 17, nb: null, cp: [3,3,3,2], b: ["CSE","ECE","EEE","Mech","Civil","Chem","MME","Mining","IT","AIML","Comm"] },
  { n: "NIT Rourkela", s: "Odisha", d: "Rourkela", t: "NIT", r: 13, nb: null, cp: [1,2,3,5], b: ["CSE","ECE","EEE","Mech","Civil","Chem","MME","Mining","Bio","Cer","Food"] },
  { n: "NIT Warangal", s: "Telangana", d: "Warangal", t: "NIT", r: 28, nb: null, cp: [1,2,2,3], b: ["CSE","ECE","EEE","Mech","Civil","Chem","MME","Bio"] },
  { n: "NIT Calicut", s: "Kerala", d: "Kozhikode", t: "NIT", r: 21, nb: null, cp: [1,2,3,4], b: ["CSE","ECE","EEE","Mech","Civil","Chem","MME","Bio","Prod","Arch"] },
  { n: "MNIT Jaipur", s: "Rajasthan", d: "Jaipur", t: "NIT", r: 42, nb: null, cp: [1,2,2,3], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Arch"] },
  { n: "VNIT Nagpur", s: "Maharashtra", d: "Nagpur", t: "NIT", r: 44, nb: null, cp: [1,2,3,3], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Mining","Arch"] },
  { n: "MANIT Bhopal", s: "Madhya Pradesh", d: "Bhopal", t: "NIT", r: 81, nb: null, cp: [1,2,2,3], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Arch"] },
  { n: "NIT Kurukshetra", s: "Haryana", d: "Kurukshetra", t: "NIT", r: 85, nb: null, cp: [2,2,2,1], b: ["CSE","ECE","EE","Mech","Civil","IT","Prod"] },
  { n: "SVNIT Surat", s: "Gujarat", d: "Surat", t: "NIT", r: 66, nb: null, cp: [2,2,1,2], b: ["CSE","ECE","EE","Mech","Civil","Chem","AIDS"] },
  { n: "MNNIT Allahabad", s: "Uttar Pradesh", d: "Prayagraj", t: "NIT", r: 62, nb: null, cp: [1,2,2,3], b: ["CSE","ECE","EE","Mech","Civil","Chem","Bio","Prod"] },
  { n: "NIT Jalandhar", s: "Punjab", d: "Jalandhar", t: "NIT", r: 55, nb: null, cp: [2,2,1,4], b: ["CSE","ECE","EE","Mech","Civil","Chem","IT","Textile","Bio"] },
  { n: "NIT Patna", s: "Bihar", d: "Patna", t: "NIT", r: 53, nb: null, cp: [1,2,1,2], b: ["CSE","ECE","EE","Mech","Civil","Arch"] },
  { n: "NIT Silchar", s: "Assam", d: "Silchar", t: "NIT", r: 50, nb: null, cp: [1,3,1,1], b: ["CSE","ECE","EE","Mech","Civil","ECE"] },
  { n: "NIT Durgapur", s: "West Bengal", d: "Burdwan (Purba)", t: "NIT", r: 49, nb: null, cp: [2,2,2,3], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Bio","IT"] },
  { n: "NIT Jamshedpur", s: "Jharkhand", d: "Jamshedpur", t: "NIT", r: 82, nb: null, cp: [1,3,3,1], b: ["CSE","ECE","EE","Mech","Civil","MME","Prod","Comm"] },
  { n: "NIT Raipur", s: "Chhattisgarh", d: "Raipur", t: "NIT", r: 86, nb: null, cp: [2,2,3,4], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Bio","Arch","IT","Mining"] },
  { n: "NIT Agartala", s: "Tripura", d: "Agartala", t: "NIT", r: null, nb: "101-150", cp: [1,2,2,1], b: ["CSE","ECE","EE","Mech","Civil","Prod"] },
  { n: "NIT Hamirpur", s: "Himachal Pradesh", d: "Hamirpur", t: "NIT", r: 97, nb: null, cp: [1,2,2,3], b: ["CSE","ECE","EE","Mech","Civil","MME","Chem","Arch"] },
  { n: "NIT Srinagar", s: "Jammu and Kashmir", d: "Srinagar", t: "NIT", r: 73, nb: null, cp: [2,2,2,2], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","IT"] },
  { n: "NIT Uttarakhand", s: "Uttarakhand", d: "Srinagar (UK)", t: "NIT", r: null, nb: "151-200", cp: [1,2,1,1], b: ["CSE","ECE","EE","Mech","Civil"] },
  { n: "NIT Goa", s: "Goa", d: "Cuncolim", t: "NIT", r: null, nb: "101-150", cp: [1,2,1,1], b: ["CSE","ECE","EE","Mech","Civil"] },
  { n: "NIT Sikkim", s: "Sikkim", d: "Ravangla", t: "NIT", r: null, nb: "151-200", cp: [1,2,1,1], b: ["CSE","ECE","EE","Mech","Civil"] },
  { n: "NIT Manipur", s: "Manipur", d: "Imphal", t: "NIT", r: null, nb: "151-200", cp: [1,2,1,1], b: ["CSE","ECE","EE","Mech","Civil"] },
  { n: "NIT Meghalaya", s: "Meghalaya", d: "Shillong", t: "NIT", r: 83, nb: null, cp: [1,2,1,1], b: ["CSE","ECE","EE","Mech","Civil"] },
  { n: "NIT Mizoram", s: "Mizoram", d: "Aizawl", t: "NIT", r: null, nb: "101-150", cp: [1,2,1,1], b: ["CSE","ECE","EE","Mech","Civil"] },
  { n: "NIT Nagaland", s: "Nagaland", d: "Dimapur", t: "NIT", r: null, nb: "101-150", cp: [1,2,1,1], b: ["CSE","ECE","EE","Mech","Civil"] },
  { n: "NIT Andhra Pradesh", s: "Andhra Pradesh", d: "Tadepalligudem", t: "NIT", r: null, nb: "201-300", cp: [1,2,2,2], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME"] },
  { n: "NIT Arunachal Pradesh", s: "Arunachal Pradesh", d: "Jote", t: "NIT", r: null, nb: "101-150", cp: [1,2,1,1], b: ["CSE","ECE","EE","Mech","Civil"] },
  { n: "NIT Delhi", s: "Delhi", d: "North-West Delhi", t: "NIT", r: 65, nb: null, cp: [1,2,1,1], b: ["CSE","ECE","EE","Mech","Civil"] },
  { n: "NIT Puducherry", s: "Puducherry", d: "Karaikal", t: "NIT", r: 99, nb: null, cp: [1,2,1,1], b: ["CSE","ECE","EE","Mech","Civil"] },
  // ── IIITs ──
  { n: "IIIT Hyderabad", s: "Telangana", d: "Hyderabad", t: "IIIT", r: 38, nb: null, cp: [4,1,0,1], b: ["CSE","ECE","CSE+Math","Bldg Sci","Comp & Lang","CSE+CompFin"] },
  { n: "IIIT Allahabad", s: "Uttar Pradesh", d: "Prayagraj", t: "IIIT", r: null, nb: "101-150", cp: [2,0,0,1], b: ["CSE","IT","IT+BI"] },
  { n: "IIIT Delhi", s: "Delhi", d: "South Delhi", t: "IIIT", r: 63, nb: null, cp: [6,1,0,0], b: ["CSE","ECE","CSE+AI","CSE+SS","CSE+Bio","CSE+Design","Math+CS"] },
  { n: "IIIT Bangalore", s: "Karnataka", d: "Bengaluru Urban", t: "IIIT", r: 69, nb: null, cp: [1,1,0,0], b: ["CSE","ECE"] },
  { n: "IIIT Sri City", s: "Andhra Pradesh", d: "Chittoor", t: "IIIT", r: null, nb: null, cp: [2,1,0,0], b: ["CSE","ECE","AIDS"] },
  { n: "IIIT-DM Jabalpur", s: "Madhya Pradesh", d: "Jabalpur", t: "IIIT", r: null, nb: "101-150", cp: [1,1,1,1], b: ["CSE","ECE","Mech","Smart Mfg"] },
  { n: "IIIT Kottayam", s: "Kerala", d: "Kottayam", t: "IIIT", r: null, nb: null, cp: [2,1,0,0], b: ["CSE","ECE","CSE+AI"] },
  { n: "IIIT Vadodara", s: "Gujarat", d: "Gandhinagar", t: "IIIT", r: null, nb: null, cp: [2,1,0,0], b: ["CSE","ECE","IT"] },
  // ── Institutes of Eminence ──
  { n: "IISc Bangalore", s: "Karnataka", d: "Bengaluru Urban", t: "IoE", r: null, nb: null, cp: [1,2,4,5], b: ["CSE","ECE","EE","Mech","Civil","Chem","MME","Aero","Bio","Math","Env","Robot"] },
  { n: "BHU Varanasi (IoE)", s: "Uttar Pradesh", d: "Varanasi", t: "IoE", r: null, nb: null, cp: [1,1,3,4], b: ["CSE","ECE","Mech","Civil","Chem","MME","Mining","Bio","Pharma"] },
  { n: "Jadavpur University", s: "West Bengal", d: "Kolkata", t: "IoE", r: 18, nb: null, cp: [2,2,3,5], b: ["CSE","IT","ECE","EE","Mech","Civil","Chem","MME","Prod","Food","Pharma","Arch"] },
  { n: "Delhi University (DU)", s: "Delhi", d: "North Delhi", t: "IoE", r: null, nb: null, cp: [1,2,0,0], b: ["CSE","ECE","EE"] },
  { n: "BITS Pilani", s: "Rajasthan", d: "Jhunjhunu", t: "IoE", r: 11, nb: null, cp: [1,2,2,7], b: ["CSE","ECE","EEE","Mech","Civil","Chem","MME","Mfg","ENI","Bio","Pharma","EngPhy"] },
  { n: "MAHE Manipal", s: "Karnataka", d: "Udupi", t: "IoE", r: 59, nb: null, cp: [3,2,4,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Aero","Bio","Auto","Mechatronics","DataSci"] },
  { n: "KIIT Bhubaneswar", s: "Odisha", d: "Bhubaneswar", t: "IoE", r: 36, nb: null, cp: [4,2,3,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Auto","Aero","Bio","AIML","Cyber"] },
  // ── Central / others ──
  { n: "Jamia Millia Islamia", s: "Delhi", d: "South-East Delhi", t: "Central", r: 24, nb: null, cp: [2,2,1,2], b: ["CSE","IT","ECE","EE","Mech","Civil","Arch"] },
  { n: "IIEST Shibpur", s: "West Bengal", d: "Howrah", t: "Central", r: 54, nb: null, cp: [2,2,4,4], b: ["CSE","IT","ECE","EE","Mech","Civil","Chem","MME","Mining","Aero","Min","Arch"] },
  // ── State govt ──
  { n: "Anna University CEG", s: "Tamil Nadu", d: "Chennai", t: "State", r: 20, nb: null, cp: [2,2,5,9], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio","Geo","Aero","Auto","Mining","Industrial","Mfg","Mat","Min","Print","Rubber"] },
  { n: "DTU (Delhi Tech Univ)", s: "Delhi", d: "North-West Delhi", t: "State", r: 30, nb: null, cp: [3,2,2,7], b: ["CSE","IT","ECE","EE","Mech","Civil","Chem","Bio","Auto","EnvEng","Mfg","Math","Polymer","Software"] },
  { n: "NSUT Dwarka", s: "Delhi", d: "South-West Delhi", t: "State", r: 70, nb: null, cp: [3,2,1,3], b: ["CSE","IT","ECE","EE","Mech","Civil","Bio","Mfg","AIML"] },
  { n: "COEP Pune", s: "Maharashtra", d: "Pune", t: "State", r: 90, nb: null, cp: [2,2,3,3], b: ["CSE","IT","ECE","EE","Mech","Civil","MME","Mfg","EngDes","Robot"] },
  { n: "VJTI Mumbai", s: "Maharashtra", d: "Mumbai", t: "State", r: null, nb: "101-150", cp: [2,2,2,3], b: ["CSE","IT","ECE","EE","Mech","Civil","Chem","Textile","Prod"] },
  { n: "JNTU Hyderabad (UCE)", s: "Telangana", d: "Hyderabad", t: "State", r: 94, nb: null, cp: [3,2,4,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","MME","Auto","AIDS","Mining"] },
  { n: "Osmania Univ CoE", s: "Telangana", d: "Hyderabad", t: "State", r: null, nb: "101-150", cp: [3,2,1,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio","AIML"] },
  { n: "Univ College of Engg Trivandrum", s: "Kerala", d: "Thiruvananthapuram", t: "State", r: null, nb: "101-150", cp: [2,2,1,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Arch"] },
  { n: "MNNIT (also listed)", s: "Uttar Pradesh", d: "Prayagraj", t: "State", r: 62, nb: null, cp: [1,2,1,3], b: ["CSE","ECE","EE","Mech","Civil","Chem","Bio"] },
  { n: "Andhra Univ CoE", s: "Andhra Pradesh", d: "Visakhapatnam", t: "State", r: 88, nb: null, cp: [2,2,3,4], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","MME","Mining","Geo","NavalArch"] },
  { n: "JNTU Kakinada", s: "Andhra Pradesh", d: "East Godavari", t: "State", r: null, nb: null, cp: [2,2,1,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio"] },
  { n: "MMMUT Gorakhpur", s: "Uttar Pradesh", d: "Gorakhpur", t: "State", r: 60, nb: null, cp: [2,2,2,2], b: ["CSE","IT","ECE","EE","Mech","Civil","Chem","MME"] },
  { n: "HBTU Kanpur", s: "Uttar Pradesh", d: "Kanpur Nagar", t: "State", r: null, nb: "201-300", cp: [2,2,1,8], b: ["CSE","IT","ECE","EE","Mech","Civil","Chem","Bio","Plastic","Food","Leather","Oil","Pulp"] },
  { n: "CET Trivandrum", s: "Kerala", d: "Thiruvananthapuram", t: "State", r: null, nb: "101-150", cp: [2,2,1,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Arch"] },
  { n: "GEC Thrissur", s: "Kerala", d: "Thrissur", t: "State", r: null, nb: null, cp: [1,2,2,1], b: ["CSE","ECE","EEE","Mech","Civil","Prod"] },
  { n: "PDPU Gandhinagar", s: "Gujarat", d: "Gandhinagar", t: "State", r: 98, nb: null, cp: [2,2,1,3], b: ["CSE","ECE","EE","Mech","Civil","Chem","Petro","ICT"] },
  { n: "LD College of Engg", s: "Gujarat", d: "Ahmedabad", t: "State", r: null, nb: null, cp: [2,2,2,6], b: ["CSE","IT","ECE","EE","Mech","Civil","Chem","Auto","Plastic","Textile","Env","Rubber"] },
  { n: "M.S. University Baroda", s: "Gujarat", d: "Vadodara", t: "State", r: null, nb: "201-300", cp: [2,2,2,5], b: ["CSE","IT","ECE","EE","Mech","Civil","Chem","Metal","Textile","Water Resources","Arch"] },
  // ── Deemed universities ──
  { n: "BITS Hyderabad", s: "Telangana", d: "Hyderabad", t: "Deemed", r: null, nb: null, cp: [1,2,1,7], b: ["CSE","ECE","EEE","Mech","Civil","Chem","Mfg","ENI","Bio","Pharma","EngPhy"] },
  { n: "BITS Goa", s: "Goa", d: "Sancoale", t: "Deemed", r: null, nb: null, cp: [1,2,1,4], b: ["CSE","ECE","EEE","Mech","Chem","Mfg","ENI","EngPhy"] },
  { n: "VIT Vellore", s: "Tamil Nadu", d: "Vellore", t: "Deemed", r: 16, nb: null, cp: [5,2,4,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio","Auto","Aero","AIML","AIDS","Cyber","Robot"] },
  { n: "VIT-AP Amaravati", s: "Andhra Pradesh", d: "Guntur", t: "Deemed", r: null, nb: null, cp: [4,2,1,2], b: ["CSE","ECE","EEE","Mech","Civil","AIML","AIDS","Cyber","Bio"] },
  { n: "SRM IST Chennai", s: "Tamil Nadu", d: "Kanchipuram", t: "Deemed", r: 14, nb: null, cp: [6,2,4,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio","Auto","Aero","AIML","Cyber","DataSci","Mechatronics","Software"] },
  { n: "SRM University AP", s: "Andhra Pradesh", d: "Guntur", t: "Deemed", r: null, nb: null, cp: [2,2,1,1], b: ["CSE","ECE","EEE","Mech","Civil","AIML"] },
  { n: "SASTRA University", s: "Tamil Nadu", d: "Thanjavur", t: "Deemed", r: 40, nb: null, cp: [3,2,2,4], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio","Mechatronics","AIDS","EngDes"] },
  { n: "Amrita Coimbatore", s: "Tamil Nadu", d: "Coimbatore", t: "Deemed", r: 23, nb: null, cp: [4,2,3,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Aero","AIDS","Cyber","Robot","EngDes"] },
  { n: "Amrita Amritapuri", s: "Kerala", d: "Kollam", t: "Deemed", r: null, nb: null, cp: [2,2,1,1], b: ["CSE","ECE","EEE","Mech","Civil","AIDS"] },
  { n: "Thapar Institute", s: "Punjab", d: "Patiala", t: "Deemed", r: 29, nb: null, cp: [2,2,3,3], b: ["CSE","ECE","EE","Mech","Civil","Chem","Bio","CompEngg","Mechatronics","Robot"] },
  { n: "ICT Mumbai", s: "Maharashtra", d: "Mumbai", t: "Deemed", r: 41, nb: null, cp: [0,0,0,9], b: ["Chem","Pharma","Polymer","Surface Coat","Food","Bio","Textile","FibreTextile","EngDes"] },
  { n: "Manipal Univ Jaipur", s: "Rajasthan", d: "Jaipur", t: "Deemed", r: 58, nb: null, cp: [3,2,3,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio","Aero","Auto","AIML"] },
  { n: "Symbiosis Inst of Tech", s: "Maharashtra", d: "Pune", t: "Deemed", r: 46, nb: null, cp: [2,2,2,1], b: ["CSE","ECE","EEE","Mech","Civil","AIML","Robot"] },
  { n: "DAIICT Gandhinagar", s: "Gujarat", d: "Gandhinagar", t: "Deemed", r: null, nb: "201-300", cp: [3,0,0,1], b: ["ICT","CSE","ICT+CompSci","Math&Stats"] },
  { n: "Nirma University", s: "Gujarat", d: "Ahmedabad", t: "Deemed", r: null, nb: "101-150", cp: [2,2,3,2], b: ["CSE","IT","ECE","EE","Mech","Civil","Chem","Robot","Mechatronics"] },
  { n: "IIIT-Bangalore", s: "Karnataka", d: "Bengaluru Urban", t: "Deemed", r: 69, nb: null, cp: [1,2,0,0], b: ["CSE","ECE","DigComm"] },
  { n: "Karunya Institute", s: "Tamil Nadu", d: "Coimbatore", t: "Deemed", r: null, nb: "101-150", cp: [3,2,2,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Aero","Bio","Food","AIDS"] },
  { n: "KLE Tech University", s: "Karnataka", d: "Hubli-Dharwad", t: "Deemed", r: null, nb: "151-200", cp: [1,2,2,1], b: ["CSE","ECE","EEE","Mech","Civil","AutoEngg"] },
  { n: "JSS Tech University", s: "Karnataka", d: "Mysuru", t: "Deemed", r: null, nb: "201-300", cp: [2,2,1,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Bio"] },
  { n: "GITAM Visakhapatnam", s: "Andhra Pradesh", d: "Visakhapatnam", t: "Deemed", r: null, nb: "101-150", cp: [3,2,1,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio","AIML"] },
  { n: "K L University (KLU)", s: "Andhra Pradesh", d: "Guntur", t: "Deemed", r: 35, nb: null, cp: [4,2,1,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Bio","AIML","Cyber"] },
  { n: "MIT WPU Pune", s: "Maharashtra", d: "Pune", t: "Deemed", r: null, nb: "101-150", cp: [2,2,4,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Auto","Mechatronics","Robot"] },
  { n: "BIT Mesra", s: "Jharkhand", d: "Ranchi", t: "Deemed", r: 51, nb: null, cp: [2,2,1,6], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio","Pharma","Food","Space"] },
  // ── Private ──
  { n: "PSG Coimbatore", s: "Tamil Nadu", d: "Coimbatore", t: "Private", r: 67, nb: null, cp: [3,2,5,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Auto","Bio","Prod","Robot","Mechatronics","AIML"] },
  { n: "LNMIIT Jaipur", s: "Rajasthan", d: "Jaipur", t: "Private", r: null, nb: "201-300", cp: [1,1,2,1], b: ["CSE","ECE","CCE","Mech","Mechatronics"] },
  { n: "SSN College of Engg", s: "Tamil Nadu", d: "Kanchipuram", t: "Private", r: 47, nb: null, cp: [2,2,1,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio"] },
  { n: "Thiagarajar College of Engg", s: "Tamil Nadu", d: "Madurai", t: "Private", r: null, nb: "101-150", cp: [3,2,2,1], b: ["CSE","IT","ECE","EEE","Mech","Civil","Mechatronics","AIDS"] },
  { n: "Kumaraguru College of Tech", s: "Tamil Nadu", d: "Coimbatore", t: "Private", r: null, nb: "151-200", cp: [3,2,3,1], b: ["CSE","IT","ECE","EEE","Mech","Civil","Auto","AIDS","Robot"] },
  { n: "Coimbatore Inst of Technology", s: "Tamil Nadu", d: "Coimbatore", t: "Private", r: null, nb: "101-150", cp: [3,2,1,1], b: ["CSE","IT","ECE","EEE","Mech","Civil","AIDS"] },
  { n: "Bannari Amman Inst of Tech", s: "Tamil Nadu", d: "Erode", t: "Private", r: null, nb: null, cp: [3,2,2,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Bio","AIML","Mechatronics","Food"] },
  { n: "Velammal Engineering College", s: "Tamil Nadu", d: "Chennai", t: "Private", r: null, nb: null, cp: [4,2,1,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Bio","AIDS","Cyber"] },
  { n: "Sri Venkateswara CoE", s: "Tamil Nadu", d: "Kanchipuram", t: "Private", r: null, nb: "201-300", cp: [3,2,1,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Bio","AIDS"] },
  { n: "Easwari Engineering College", s: "Tamil Nadu", d: "Chennai", t: "Private", r: null, nb: "101-150", cp: [4,2,1,1], b: ["CSE","IT","ECE","EEE","Mech","Civil","AIML","AIDS"] },
  { n: "Rajalakshmi Engineering College", s: "Tamil Nadu", d: "Chennai", t: "Private", r: null, nb: "101-150", cp: [4,2,1,1], b: ["CSE","IT","ECE","EEE","Mech","Civil","AIML","AIDS"] },
  { n: "RV College of Engineering", s: "Karnataka", d: "Bengaluru Urban", t: "Private", r: null, nb: "101-150", cp: [3,2,2,4], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio","AIML","Mechatronics","EngDes"] },
  { n: "BMS College of Engineering", s: "Karnataka", d: "Bengaluru Urban", t: "Private", r: null, nb: "151-200", cp: [3,2,2,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Auto","AIML"] },
  { n: "MS Ramaiah Inst of Tech", s: "Karnataka", d: "Bengaluru Urban", t: "Private", r: 75, nb: null, cp: [3,2,2,3], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Auto","AIML","Bio"] },
  { n: "PES University", s: "Karnataka", d: "Bengaluru Urban", t: "Private", r: null, nb: "101-150", cp: [2,2,1,2], b: ["CSE","ECE","EEE","Mech","Civil","Bio","AIML"] },
  { n: "Dayananda Sagar Univ", s: "Karnataka", d: "Bengaluru Urban", t: "Private", r: null, nb: "201-300", cp: [3,2,2,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Auto","AIML","Bio"] },
  { n: "VNR VJIET Hyderabad", s: "Telangana", d: "Hyderabad", t: "Private", r: null, nb: "151-200", cp: [3,2,2,1], b: ["CSE","IT","ECE","EEE","Mech","Civil","Auto","AIML"] },
  { n: "Vasavi College of Engg", s: "Telangana", d: "Hyderabad", t: "Private", r: null, nb: null, cp: [3,2,1,1], b: ["CSE","IT","ECE","EEE","Mech","Civil","AIML"] },
  { n: "CBIT Hyderabad", s: "Telangana", d: "Hyderabad", t: "Private", r: null, nb: "151-200", cp: [3,2,1,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","AIML","Bio"] },
  { n: "MGIT Hyderabad", s: "Telangana", d: "Ranga Reddy", t: "Private", r: null, nb: null, cp: [3,2,1,1], b: ["CSE","IT","ECE","EEE","Mech","Civil","AIDS"] },
  { n: "GNITS Hyderabad", s: "Telangana", d: "Hyderabad", t: "Private", r: null, nb: "201-300", cp: [3,2,1,0], b: ["CSE","IT","ECE","EEE","Mech","AIDS"] },
  { n: "PICT Pune", s: "Maharashtra", d: "Pune", t: "Private", r: null, nb: null, cp: [3,2,1,1], b: ["CSE","IT","ECE","EE","Mech","Civil","AIDS"] },
  { n: "K J Somaiya Inst", s: "Maharashtra", d: "Mumbai", t: "Private", r: null, nb: null, cp: [3,2,1,1], b: ["CSE","IT","ECE","EEE","Mech","Civil","AIML"] },
  { n: "VESIT Mumbai", s: "Maharashtra", d: "Mumbai", t: "Private", r: null, nb: null, cp: [3,2,0,0], b: ["CSE","IT","ECE","EE","AIDS"] },
  { n: "JSS Academy of Tech", s: "Uttar Pradesh", d: "Gautam Buddha Nagar", t: "Private", r: null, nb: "201-300", cp: [2,2,1,2], b: ["CSE","IT","ECE","EE","Mech","Civil","Bio"] },
  { n: "Amity University Noida", s: "Uttar Pradesh", d: "Gautam Buddha Nagar", t: "Private", r: 37, nb: null, cp: [3,2,4,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Aero","Bio","AIML","Auto","Robot"] },
  { n: "Bennett University", s: "Uttar Pradesh", d: "Gautam Buddha Nagar", t: "Private", r: null, nb: null, cp: [3,1,1,1], b: ["CSE","ECE","Mech","AIML","Cyber","Bio"] },
  { n: "AKGEC Ghaziabad", s: "Uttar Pradesh", d: "Ghaziabad", t: "Private", r: null, nb: null, cp: [3,2,1,0], b: ["CSE","IT","ECE","EE","Mech","AIDS"] },
  { n: "TKM College of Engg", s: "Kerala", d: "Kollam", t: "Private", r: null, nb: null, cp: [2,2,1,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Arch"] },
  { n: "Rajagiri School of Engg", s: "Kerala", d: "Ernakulam", t: "Private", r: null, nb: null, cp: [3,2,1,1], b: ["CSE","IT","ECE","EEE","Mech","Civil","AIDS"] },
  { n: "Heritage Inst of Tech", s: "West Bengal", d: "Kolkata", t: "Private", r: null, nb: null, cp: [2,2,1,2], b: ["CSE","IT","ECE","EE","Mech","Civil","Bio"] },
  { n: "Techno India University", s: "West Bengal", d: "Kolkata", t: "Private", r: null, nb: null, cp: [3,2,1,2], b: ["CSE","IT","ECE","EE","Mech","Civil","Bio","AIML"] },
  { n: "Sandip University Nashik", s: "Maharashtra", d: "Nashik", t: "Private", r: null, nb: null, cp: [3,1,1,1], b: ["CSE","IT","ECE","Mech","Civil","AIDS"] },
  { n: "Chitkara University", s: "Punjab", d: "Mohali", t: "Private", r: 89, nb: null, cp: [2,2,1,1], b: ["CSE","ECE","EEE","Mech","Civil","AIML"] },
  { n: "LPU Phagwara", s: "Punjab", d: "Kapurthala", t: "Private", r: 48, nb: null, cp: [3,2,3,4], b: ["CSE","IT","ECE","EEE","Mech","Civil","Chem","Bio","Aero","Auto","AIDS","Food"] },
  { n: "Chandigarh University", s: "Punjab", d: "Mohali", t: "Private", r: 31, nb: null, cp: [3,2,3,2], b: ["CSE","IT","ECE","EEE","Mech","Civil","Auto","Aero","AIML","Bio"] },
];
